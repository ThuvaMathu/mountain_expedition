        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-900">Summit Quest</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/mountains" className="text-gray-700 hover:text-teal-600 transition-colors">
              {t("mountains")}
            </Link>
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
              <Link href="/" className="block px-3 py-2 text-gray-700 hover:text-teal-600">
                {t("home")}
              </Link>
              <Link href="/mountains" className="block px-3 py-2 text-gray-700 hover:text-teal-600">
                {t("mountains")}
              </Link>
              <Link href="/gallery" className="block px-3 py-2 text-gray-700 hover:text-teal-600">
                {t("gallery")}
              </Link>
              <Link href="/blog" className="block px-3 py-2 text-gray-700 hover:text-teal-600">
                {t("blog")}
              </Link>
              <Link href="/about" className="block px-3 py-2 text-gray-700 hover:text-teal-600">
                {t("about")}
              </Link>
