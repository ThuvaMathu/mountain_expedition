    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <div>
        ...
        >
          ...
          <option value="seven-summits">{t('seven_summits')}</option>
          <option value="himalayas">{t('himalayas')}</option>
          <option value="indian-peaks">{t('indian_peaks')}</option>
        </select>
      </div>
      ...
      <div>
        ...
        >
          ...
          <option value="budget">{t('budget')} ({'< $2,000'})</option>
          <option value="mid">{t('mid_range')} ($2,000 - $10,000)</option>
          <option value="premium">{t('premium')} ({'> $10,000'})</option>
        </select>
      </div>
