...
export function ExploreSection() {
  ...
  return (
    <section
      id="next-section"
      className="relative min-h-screen overflow-hidden bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50"
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-7xl mx-auto">
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            {/* Main Heading */}
            <h2 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 leading-tight uppercase">
              NEVER STOP
              <br />
