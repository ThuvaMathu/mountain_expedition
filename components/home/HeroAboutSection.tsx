      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative order-1 lg:order-2 h-[500px] md:h-[600px] w-full">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 md:w-80 h-96 md:h-[450px] rounded-[100px] overflow-hidden shadow-2xl z-20 border-4 border-white">
              <img
            ...
            <div className="absolute top-1/4 left-0 md:left-4 w-40 md:w-48 h-56 md:h-64 rounded-[60px] overflow-hidden shadow-xl z-10 border-4 border-white transform -rotate-6">
              <img
            ...
            <div className="absolute bottom-1/4 right-0 md:right-4 w-40 md:w-48 h-56 md:h-64 rounded-[60px] overflow-hidden shadow-xl z-10 border-4 border-white transform rotate-6">
              <img
            ...
            {/* Top Right Decorative (Small) */}
             <div className="absolute top-10 right-10 md:right-20 w-24 h-24 rounded-full overflow-hidden shadow-lg z-0 border-2 border-teal-100 opacity-80">
              <img
             ...
             <div className="absolute bottom-10 left-10 md:left-20 w-24 h-24 rounded-full overflow-hidden shadow-lg z-0 border-2 border-teal-100 opacity-80">
              <img
