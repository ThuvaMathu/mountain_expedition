        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-gray-600">{touristPackage.duration}</div>
                </div>
              </div>
              <div className="flex items-center space-x-3">
            ...
            <div className="bg-gradient-to-r from-teal-50 to-blue-50 rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-lg p-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Comprehensive travel insurance recommended for international
                    trips.
                  </p>
                </div>
                <div className="bg-white rounded-lg p-4">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              {(showAllItinerary
                ? touristPackage.itinerary
                : touristPackage.itinerary.slice(0, 5)
              ).map((day) => (
            ...
            {touristPackage.itinerary.length > 5 && (
              <Button
                variant="outline"
                className="mt-6"
