...
import { Search, Filter, Plane, Globe, Star, Users } from "lucide-react";
        ...
        <div className="bg-gradient-to-r from-teal-600 to-teal-700 rounded-xl text-white p-8 mb-12">
          <div className="text-center">
            ...
            <p className="text-xl text-teal-100 max-w-3xl mx-auto mb-8">
              Discover the world's most incredible destinations with our curated
              international travel packages. From exotic tropical islands to
              historic European cities, adventure awaits across the globe.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
                ...
                <p className="text-teal-100 text-sm">Countries</p>
              </div>
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
                <div className="flex items-center justify-center space-x-2 mb-2">
                ...
                <p className="text-teal-100 text-sm">Starting From</p>
              </div>
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
                <div className="flex items-center justify-center space-x-2 mb-2">
                ...
                <p className="text-teal-100 text-sm">Global Travelers</p>
              </div>
            </div>
          </div>
        </div>
