...
import { MapPin, Calendar, TrendingUp, Star, Users, Clock, Shield, Award, Camera } from 'lucide-react'
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-600">({mountain.totalReviews} reviews)</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">About This Expedition</h2>
              <p className="text-gray-700 leading-relaxed mb-6">{mountain.longDescription}</p>
            ...
            {/* Itinerary Preview */}
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Expedition Itinerary</h2>
                ...
                {mountain.itinerary.slice(0, 5).map((day) => (
                  <div key={day.day} className="border-l-4 border-blue-600 pl-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm text-gray-600">{day.altitude}m</span>
                    </div>
