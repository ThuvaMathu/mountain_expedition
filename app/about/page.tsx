          ...
          <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16">
            <div className="grid gap-10 md:grid-cols-2 md:items-center">
              ...
              <div>
                ...
                <p className="mt-3 text-lg text-gray-700">
                  She is the first woman from Tamil Nadu to conquer Mount
                  Everest and complete the Seven Summits, the tallest peaks on
                  all seven continents. She also holds the record as the fastest
                  Indian woman to achieve this legendary feat in just 2 years
                  and 25 days. Her mission is to ignite courage in others,
                  especially women, to face challenges and achieve victories.
                </p>
                <div className="mt-6 flex flex-wrap gap-3">
                  <a
                    href="#timeline"
              ...
              <div className="grid gap-10 md:grid-cols-2 md:gap-14 ">
                ...
                <div className="order-1 md:order-2">
                  ...
                  <p className="mt-4 text-gray-700">
                    ...
                    never decide the limits of our lives, using her Seven
                    Summits feat to inspire true resilience.
                  </p>
                  <p className="mt-4 text-gray-700">
                    As the fastest Indian woman to complete the Seven Summits,
                    her mission is to ignite courage in others, especially
                    women. She is a Japanese Interpreter and Author of the book
                    "Imayamathai Thotta sathanai Payanam", using her story to
                    show how to face challenges head-on and achieve victories in
                    their homes, careers, and personal dreams.
                  </p>
                  <div className="mt-6">
                    <a
                      href="#goals"
              ...
              <div className="grid gap-8 lg:grid-cols-3">
                <div className="lg:col-span-2">
                  ...
                  <p className="mt-4 text-gray-700">
                    ...
                    completing the feat in a record 2 years and 25 days. Known
                    for its extreme cold and unpredictable weather, the mountain
                  ...
                  <p className="mt-4 text-gray-700">
                    Achieving the summit on June 16, 2025, was not only a
                    personal triumph but an inspiration for others, especially
                    young people and women, to pursue their own goals with
                    discipline and determination. Her philosophy remains clear:
                    success is born from preparation, courage, and a relentless
                ...
                <div className="rounded-xl border border-teal-200 bg-teal-50 p-6">
                  ...
                  <ul className="mt-3 space-y-2 text-teal-900/90">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1 h-2.5 w-2.5 shrink-0 rounded-full bg-teal-600" />
                      Fastest Indian woman to achieve the legendary Seven
                      Summits feat.
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1 h-2.5 w-2.5 shrink-0 rounded-full bg-teal-600" />
              ...
              <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-2 text-gray-700">
                    ...
                    tallest peaks on all seven continents) in just 2 years and
                    25 days.
                  </p>
                </div>
                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-2 text-gray-700">
                    Dedicated to inspiring women and youth to break fear and
                    face challenges head-on, in line with her mantra of courage
                    and discipline.
                  </p>
                </div>
              </div>
              ...
              <div className="grid gap-8 lg:grid-cols-2">
                ...
                <div className="rounded-xl border border-teal-200 bg-teal-50 p-6">
                  ...
                  <p className="mt-2 text-teal-900/90">
                    Your support fuels training initiatives, safety education,
                    and outreach. Get involved as a partner, donor, or
                    volunteer—and help shape the next generation of explorers.
                  </p>
                ...
                <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
                  <div>
                    ...
                    <p className="mt-3 text-teal-50">
                      Learn more about the Seven Summits journey, support
                      upcoming initiatives, or get involved in programs that
                      equip the next generation of climbers.
                    </p>
                  </div>
